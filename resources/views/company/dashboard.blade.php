    ...
    >
        ...
        >
            ...
            <a
                ...
                class="mx-auto mt-[22px] flex h-[42px] w-[170px]
                       items-center justify-center
                       rounded-lg border border-[#bfd4f5]
                       bg-white text-sm font-bold text-[#075fe4]
                       transition hover:bg-[#f5f9ff]"
            >
                View All Activities
            </a>
        </div>
        ...
        >
            ...
            <div
                ...
                class="grid gap-3"
            >
                {{-- Actions inserted through JavaScript --}}
            </div>
        </div>
    ...
    async function loadDashboard() {
        ...
        */
        ...
        if (profile.approval_status) {
            ...
            dashboardStatus.textContent =
                `Approval: ${formatStatus(profile.approval_status)}. Here's what's happening today.`;
