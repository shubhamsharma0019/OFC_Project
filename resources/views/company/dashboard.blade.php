...
@php
    ...
    $dashboardHiringPackages = [
        ['name' => 'Starter', 'desc' => 'Perfect for getting started', 'price' => '₹499', 'period' => '/month', 'button' => 'Choose Starter', 'popular' => false, 'items' => ['10 Job Postings', '50 Direct Mode Resumes (5 per job extra)', '20 Fast Track Mode Resumes (2 per job extra)', 'Candidate Contact Access', 'Email Support']],
        ['name' => 'Growth', 'desc' => 'Scale your hiring', 'price' => '₹799', 'period' => '/month', 'button' => 'Choose Growth', 'popular' => true, 'items' => ['25 Job Postings', '150 Direct Mode Resumes (6 per job extra)', '60 Fast Track Mode Resumes (2.5 per job extra)', 'Candidate Contact Access', 'Priority Support']],
        ['name' => 'Professional', 'desc' => 'For active hiring teams', 'price' => '₹999', 'period' => '/month', 'button' => 'Choose Professional', 'popular' => false, 'items' => ['60 Job Postings', '400 Direct Mode Resumes (7 per job extra)', '160 Fast Track Mode Resumes (2.5 per job extra)', 'Candidate Contact Access', 'Priority Support', 'Dedicated Account Manager']],
