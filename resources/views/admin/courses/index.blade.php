...
@php
    $activePage = 'courses';
    $stats = [
        ['label' => 'Total Courses', 'value' => '248', 'tone' => 'bg-[#eaf2ff] text-[#075fe4]'],
    ...
    $rows = [
        ['name' => 'Full Stack Development', 'category' => 'Course', 'owner' => 'OnlyFreshers Team', 'status' => 'Published'],
        ['name' => 'Data Science Track', 'category' => 'Course', 'owner' => 'Admin Team', 'status' => 'Active'],
        ['name' => 'Review Queue Item', 'category' => 'Course', 'owner' => 'Operations', 'status' => 'Pending'],
        ['name' => 'Monthly Highlight', 'category' => 'Course', 'owner' => 'Platform', 'status' => 'Active'],
    ];
@endphp
