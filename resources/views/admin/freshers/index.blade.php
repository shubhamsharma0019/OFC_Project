...
@php
    $activePage = 'freshers';
    $stats = [
        ['label' => 'Total Freshers', 'value' => '248', 'tone' => 'bg-[#eaf2ff] text-[#075fe4]'],
    ...
    $rows = [
        ['name' => 'Ananya Gupta', 'category' => 'Fresher', 'owner' => 'OnlyFreshers Team', 'status' => 'Active'],
        ['name' => 'Data Science Track', 'category' => 'Fresher', 'owner' => 'Admin Team', 'status' => 'Active'],
        ['name' => 'Review Queue Item', 'category' => 'Fresher', 'owner' => 'Operations', 'status' => 'Pending'],
        ['name' => 'Monthly Highlight', 'category' => 'Fresher', 'owner' => 'Platform', 'status' => 'Active'],
    ];
@endphp
