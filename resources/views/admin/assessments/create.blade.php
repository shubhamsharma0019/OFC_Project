...
@section('title', 'Create Assessment - OnlyFreshers Admin')
@section('pageTitle', 'Create Assessment')
...
@section('content')
    <section class="grid gap-5">
        <div class="rounded-lg border border-[#dce7f8] bg-white p-5 shadow-[0_12px_26px_rgba(6,25,66,.05)]">
            <p class="mb-5 text-sm leading-relaxed text-[#52607a]">Create a new assessment for courses and fresher screening.</p>
