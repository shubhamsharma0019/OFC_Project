...
@php
    ...
    $stats = [
        ['label' => 'Total Assessments', 'value' => '248', 'tone' => 'bg-[#eaf2ff] text-[#075fe4]'],
    ...
    $rows = [
        ['name' => 'React Quiz', 'category' => 'Assessment', 'owner' => 'OnlyFreshers Team', 'status' => 'Published'],
        ['name' => 'Data Science Track', 'category' => 'Assessment', 'owner' => 'Admin Team', 'status' => 'Active'],
        ['name' => 'Review Queue Item', 'category' => 'Assessment', 'owner' => 'Operations', 'status' => 'Pending'],
        ['name' => 'Monthly Highlight', 'category' => 'Assessment', 'owner' => 'Platform', 'status' => 'Active'],
    ];
@endphp
