...
@php
    ...
    $stats = [
        ['label' => 'Total Companys', 'value' => '248', 'tone' => 'bg-[#eaf2ff] text-[#075fe4]'],
    ...
    $rows = [
        ['name' => 'TechNova Solutions', 'category' => 'Company', 'owner' => 'OnlyFreshers Team', 'status' => 'Verified'],
        ['name' => 'Data Science Track', 'category' => 'Company', 'owner' => 'Admin Team', 'status' => 'Active'],
        ['name' => 'Review Queue Item', 'category' => 'Company', 'owner' => 'Operations', 'status' => 'Pending'],
        ['name' => 'Monthly Highlight', 'category' => 'Company', 'owner' => 'Platform', 'status' => 'Active'],
    ];
@endphp
