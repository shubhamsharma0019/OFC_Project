...
@php
    ...
    $stats = [
        ['label' => 'Total Partners', 'value' => '248', 'tone' => 'bg-[#eaf2ff] text-[#075fe4]'],
    ...
    $rows = [
        ['name' => 'CodeAcademy', 'category' => 'Partner', 'owner' => 'OnlyFreshers Team', 'status' => 'Verified'],
        ['name' => 'Data Science Track', 'category' => 'Partner', 'owner' => 'Admin Team', 'status' => 'Active'],
        ['name' => 'Review Queue Item', 'category' => 'Partner', 'owner' => 'Operations', 'status' => 'Pending'],
        ['name' => 'Monthly Highlight', 'category' => 'Partner', 'owner' => 'Platform', 'status' => 'Active'],
    ];
@endphp
