...
<body>
        ...
        <section class="auth-card">
            ...
            <div class="form-wrap">
                <div class="form-panel">
                    <div class="tabs">
                        <button class="tab" type="button" onclick="window.location.href='{{ $loginUrl }}'">Login</button>
                    ...
                    <form id="registerForm" data-role="{{ $isCompanyAuth ? 'company' : 'fresher' }}">
                        ...
                        <p class="switch">Already have an account? <a href="{{ $loginUrl }}">Login</a></p>
                    </form>
                </div>
            </div>
        </section>
    ...
    <script>
        ...
        registerForm.addEventListener('submit', async (event) => {
            ...
            const submitButton = registerForm.querySelector('.primary');
            ...
            try {
                const response = await fetch('/api/auth/register', {
                    ...
                    body: JSON.stringify({
                        ...
                        role: registerForm.dataset.role,
                    }),
                });
