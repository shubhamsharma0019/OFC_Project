...
<body>
    <main class="page">
        ...
        <div class="main-wrap">
            <section class="auth-card">
                <aside class="intro image-only">
                    <div class="illustration">
                        <img src="/study.svg" alt="Students learning" onerror="this.src='/direct.svg'">
                    </div>
                </aside>
                ...
                <section class="form-side">
                    <div class="form-shell">
                        ...
                        <div class="tabs">
                            <button class="tab" type="button" onclick="window.location.href='/direct-mode/register'">
                        ...
                        <form id="loginForm">
                            ...
                            <button class="primary" type="submit" id="loginButton">Login</button>
    ...
    <script>
        const icons = {
            briefcase:'<svg viewBox="0 0 24 24"><path d="M10 6V5a2 2 0 0 1 2-2h0a2 2 0 0 1 2 2v1"></path><rect x="3" y="7" width="18" height="13" rx="2"></rect><path d="M3 12h18"></path></svg>',
            graduation:'<svg viewBox="0 0 24 24"><path d="M22 10 12 5 2 10l10 5 10-5Z"></path><path d="M6 12v5c3 2 9 2 12 0v-5"></path></svg>',
            chart:'<svg viewBox="0 0 24 24"><path d="M4 19V5"></path><path d="M4 19h16"></path><rect x="7" y="12" width="3" height="4"></rect><rect x="12" y="9" width="3" height="7"></rect><rect x="17" y="6" width="3" height="10"></rect></svg>',
        ...
        document.getElementById('loginForm').addEventListener('submit', async event => {
            ...
            try {
                ...
                const dashboard = result.data.user.role === 'fresher'
                    ? '/direct-mode/dashboard'
                    : result.data.dashboard;

                window.location.href = dashboard || '/direct-mode/dashboard';
            } catch (error) {
