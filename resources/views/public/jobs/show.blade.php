            ...
            <div class="grid gap-7 lg:grid-cols-[minmax(0,1fr)_320px] lg:items-start lg:gap-[70px]">
                ...
                <aside class="min-w-0">
                    <div class="mb-[22px] rounded-lg border border-[#dce7f8] bg-white p-[22px] shadow-[0_10px_24px_rgba(6,25,66,0.04)]">
                        <a href="${job.hiring_mode === 'fast_track' ? '/fast-track/login' : '/direct-mode/login'}" class="flex h-11 w-full items-center justify-center rounded-lg border border-[#075fe4] bg-[#075fe4] text-sm font-bold text-white transition hover:bg-[#003f9e]">Apply Now</a>
                    </div>
