@php
    $fastTrackMenuItems = $menuItems ?? [
        [
            'key' => 'dashboard',
            'title' => 'Dashboard',
            'icon' => '<path d="M4 11l8-7 8 7"></path><path d="M6 10v10h12V10"></path><path d="M10 20v-6h4v6"></path>',
            'url' => '/fast-track/dashboard'
        ],
        [
            'key' => 'profile',
            'title' => 'My Profile',
            'icon' => '<circle cx="12" cy="8" r="4"></circle><path d="M4 21c0-4 3.5-7 8-7s8 3 8 7"></path>',
        ...
        [
            ...
            'url' => '/fast-track/courses'
        ],
        [
            'key' => 'details',
            'title' => 'Course Details',
            'icon' => '<path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path><path d="M14 2v6h6"></path><path d="M8 13h8M8 17h5"></path>',
            'url' => '/fast-track/course-details'
        ],
        [
            'key' => 'training',
            'title' => 'My Training',
            'icon' => '<rect x="3" y="5" width="18" height="14" rx="2"></rect><path d="m10 9 5 3-5 3z"></path>',
            'url' => '/fast-track/training'
        ],
        [
            'key' => 'progress',
            'title' => 'Training Progress',
            'icon' => '<path d="M4 19V5"></path><path d="M4 19h16"></path><path d="M8 15l3-3 3 2 5-7"></path>',
            'url' => '/fast-track/training-progress'
        ],
        [
            'key' => 'final',
            'title' => 'Final Assessment',
            'icon' => '<path d="M9 11l2 2 4-5"></path><rect x="4" y="3" width="16" height="18" rx="2"></rect><path d="M8 17h8"></path>',
            'url' => '/fast-track/final-assessment'
        ],
        [
            'key' => 'certificate',
            'title' => 'Certificate',
            'icon' => '<path d="M6 3h12v18l-6-3-6 3z"></path><path d="M9 8h6M9 12h6"></path>',
            'url' => '/fast-track/certificate'
        ],
        [
            'key' => 'jobs',
            'title' => 'Job Recommendations',
            'icon' => '<rect x="3" y="7" width="18" height="13" rx="2"></rect><path d="M8 7V5a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"></path><path d="M12 12v1"></path>',
            'url' => '/fast-track/job-recommendations'
        ],
        [
            'key' => 'applications',
            'title' => 'Applications',
            'icon' => '<path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path><path d="M14 2v6h6"></path><path d="M9 15l2 2 4-5"></path>',
            'url' => '/fast-track/applications'
        ],
        [
            'key' => 'settings',
            'title' => 'Settings',
            'icon' => '<circle cx="12" cy="12" r="3"></circle><path d="M19.4 15a1.7 1.7 0 0 0 .34 1.88l.06.06-2.83 2.83-.06-.06A1.7 1.7 0 0 0 15 19.4 1.7 1.7 0 0 0 14 21h-4a1.7 1.7 0 0 0-1-1.6 1.7 1.7 0 0 0-1.88.34l-.06.06-2.83-2.83.06-.06A1.7 1.7 0 0 0 4.6 15 1.7 1.7 0 0 0 3 14v-4a1.7 1.7 0 0 0 1.6-1 1.7 1.7 0 0 0-.34-1.88l-.06-.06 2.83-2.83.06.06A1.7 1.7 0 0 0 9 4.6 1.7 1.7 0 0 0 10 3h4a1.7 1.7 0 0 0 1 1.6 1.7 1.7 0 0 0 1.88-.34l.06-.06 2.83 2.83-.06.06A1.7 1.7 0 0 0 19.4 9 1.7 1.7 0 0 0 21 10v4a1.7 1.7 0 0 0-1.6 1Z"></path>',
            'url' => '/fast-track/settings'
        ],
        [
            'key' => 'logout',
            'title' => 'Logout',
            ...
            @foreach ($fastTrackMenuItems as $item)
                ...
                <a
                    ...
                    class="
                        ...
                        {{ ($activePage ?? '') === $item['key']
                            ? 'bg-[#eff5ff] text-[#075fe4]'
                            : (
                                $item['key'] === 'logout'
                                    ? 'text-[#061942] hover:bg-[#fff1f4] hover:text-[#ff335f]'
                                    : 'text-[#061942] hover:bg-[#f5f8ff] hover:text-[#075fe4]'
                            )
                        }}
                    "
                >
                    ...
                    <span
                        class="
                            ...
                            {{ ($activePage ?? '') === $item['key']
                                ? 'bg-white text-[#075fe4]'
                                : 'bg-[#f1f5ff] text-[#5b2cff]'
                            }}
                        "
                    >
                        <svg
