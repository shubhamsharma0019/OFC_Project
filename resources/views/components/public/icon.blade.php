@php
    ...
    $paths = [
        ...
        'cloud' => '<path d="M17.5 18H8a5 5 0 1 1 1.4-9.8A6 6 0 0 1 21 10.5 3.8 3.8 0 0 1 17.5 18z"></path>',
        ...
        'location' => '<path d="M12 21s7-5.3 7-12a7 7 0 1 0-14 0c0 6.7 7 12 7 12z"></path><circle cx="12" cy="9" r="2.5"></circle>',
